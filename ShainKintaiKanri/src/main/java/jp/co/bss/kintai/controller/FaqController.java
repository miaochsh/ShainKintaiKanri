...
public class FaqController {
	...
	public String addFAQ(HttpSession session, Model model, @RequestParam String buttonNm,
			@RequestParam String question1, @RequestParam String answer1, @RequestParam String question2,
			@RequestParam String answer2, @RequestParam String question3, @RequestParam String answer3) {
